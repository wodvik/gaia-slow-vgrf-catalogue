...
Outputs are written to bundle-local private_outputs/parent_scan by default.
For the production run, pass --out-dir pointing at the author's private
parent-scan workspace.
"""
...
DEFAULT_INPUT = BUNDLE / "private_inputs" / "slow_stars_expanded_candidates_vgrf50.csv"
