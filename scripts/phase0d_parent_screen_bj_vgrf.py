...
Default private inputs/outputs live under bundle-local private_inputs/ and
private_outputs/parent_scan.
"""
...
DEFAULT_SCREEN = BUNDLE / "private_outputs" / "parent_scan" / "gaia_parent_buffer_zpcorr_inv_screen_vgrf50.csv"
