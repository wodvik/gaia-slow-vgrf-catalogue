...
Outputs
-------
release/v2/phase14/sgrA_event_refinement_draws.csv
release/v2/phase14/sgrA_event_refinement_summary.csv
release/v2/phase14/sgrA_event_refinement_summary.json
release/v2/phase14/sgrA_event_refinement_summary.md
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    phase6 = json.loads((REPO / "release/v2/phase6/sgrA_candidate_mc.json").read_text())
