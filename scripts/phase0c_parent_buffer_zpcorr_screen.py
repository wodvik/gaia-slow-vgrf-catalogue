...
Default output:
  private_outputs/parent_scan/gaia_parent_buffer_zpcorr_inv_screen_vgrf50.csv
  private_outputs/parent_scan/gate0_zpcorr_inv_screen_summary.json
"""
...
DEFAULT_BUFFER = BUNDLE / "private_inputs" / "gaia_parent_buffer_vgrf200_full_dedup.csv"
DEFAULT_OLD = BUNDLE / "private_inputs" / "slow_stars_enriched_orbits_legacy.csv"
