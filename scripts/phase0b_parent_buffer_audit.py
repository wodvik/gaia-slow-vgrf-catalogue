...
Outputs:
  private_outputs/parent_scan/gate0_parent_buffer_summary.json
  private_outputs/parent_scan/gate0_new_legacy_lt25_candidates.csv
"""
...
DEFAULT_SCAN_DIR = BUNDLE / "private_outputs" / "parent_scan"
